				...
				<nav class="uk-navbar uk-light" data-uk-navbar="mode:click; duration: 250">
							...
							<li>
								...
								<div class="uk-navbar-dropdown">
									<ul class="uk-nav uk-navbar-dropdown-nav">
										...
										<li class="uk-nav-divider"></li>
										<li><a href="<?=$this->Url->build('/admin/logout');?>"><span data-uk-icon="icon: sign-out"></span> Logout</a></li>
									</ul>
								</div>
							</li>
						</ul>
					...
					<div class="uk-navbar-right">
						<ul class="uk-navbar-nav">
							...
							<li><a href="<?=$this->Url->build('/admin/logout');?>" data-uk-icon="icon:  sign-out" title="Sign Out" data-uk-tooltip></a></li>
							<li><a class="uk-navbar-toggle" data-uk-toggle data-uk-navbar-toggle-icon href="#offcanvas-slide" title="Menu" data-uk-tooltip></a></li>
						</ul>
					</div>
				</nav>
			</div>
